...
class SaveCustomerOrderByBatchSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        self.validate_detail_qty(order_details)
    ...
    ##TODO: validate 
    def validate_detail_qty(self, order_details):
        # for detail in order_details:
        pass
...
def validate(self, attrs):
    ...
    for customer_pack_type in customer_packing_types:
        ...
        available_pack = pack_and_serial_info.find_available_pack(packing_type_code.id)
        ...
        for sale_pack_type_detail in sale_pack_type_details:
            ...
            available_serial_no = pack_and_serial_info.find_available_serial_nos(serial_no_code.id)
            if not available_serial_no.exists():
