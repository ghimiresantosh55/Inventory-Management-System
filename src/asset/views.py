    ...
    def create(self, request, **kwargs):
        ...
        if request.data['depreciation_method'] == 2:
            ...
            try:
                ...
                return Response("Please provide specific location to this asset", status=status.HTTP_400_BAD_REQUEST)
        request.data['registration_no'] = generate_asset_re_serial()
