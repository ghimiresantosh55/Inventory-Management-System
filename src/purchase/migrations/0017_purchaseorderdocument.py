    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='purchase_order', to='purchase.purchasedocumenttype')),
                ('purchase_order', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='purchase_order_documents', to='purchase.purchaseordermaster')),
            ],
            options={
                'abstract': False,
            },
