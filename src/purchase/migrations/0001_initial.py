    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch_no', models.CharField(help_text='Batch no. max length 20', max_length=8, unique=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='purchase.warehouselocation')),
            ],
            options={
                'abstract': False,
            },
